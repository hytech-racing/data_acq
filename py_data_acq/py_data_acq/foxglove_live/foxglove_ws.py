...
from .build.py_data_acq.py_data_acq.aero_sensor_protos_np_proto_py.aero_sensor import aero_sensor_pb2
from .build.py_data_acq.py_data_acq.aero_sensor_pb2 import aero_data
